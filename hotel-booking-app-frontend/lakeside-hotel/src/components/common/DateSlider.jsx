...
function DateSlider({onDatChange, onFilterChange}) {
  ...
  const handleSelect = (ranges) => {
    ...
    onDatChange(ranges.selection.startDate, ranges.selection.endDate)
  ...
  const handleClearFilter  = () => {
    ...
    onDatChange(null, null);
    onFilterChange(null, null);
  }

  return (
    <>
      <h5 className="">Filter bookings by date</h5>
