...
function AddRoom() {
  ...
  useEffect(() => {
    if (newRoom.photo) {
      setImagePreview(URL.createObjectURL(newRoom.photo));
    }
  }, [newRoom.photo]);
  ...
  const handleImageChange = (e) => {
    ...
    setImagePreview(URL.createObjectURL(selectedImage)); // Updated line
  };
          ...
          <div className="col-md-8 col-lg-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input type="number" className='form-control' id='room-price' name='roomPrice' value={newRoom.roomPrice} onChange={handleRoomInputChange}/>
              </div>
