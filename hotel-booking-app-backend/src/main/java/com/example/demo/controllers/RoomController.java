...
import com.example.demo.exceptions.PhotoRetrievalException;
...
public class RoomController {
    ...
    private final IBookedRoomService bookingRoomService;
    ...
    public ResponseEntity<RoomResponse> addNewRoom(
        ...
        return ResponseEntity.ok(new RoomResponse(savedRoom.getId(), savedRoom.getRoomType(), savedRoom.getRoomPrice()));
    }
    ...
    public ResponseEntity<List<RoomResponse>> getAllRoms() throws SQLException {
